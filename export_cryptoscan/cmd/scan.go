...
var (
	scanCmd = &cobra.Command{
		Use:   "scan [github repository URL or local path]",
		Short: "Scan a GitHub repository or local directory for cryptographic assets",
		Long: `Scan a GitHub repository or local directory for cryptographic assets and vulnerabilities.
For GitHub repos, the URL format should be: https://github.com/owner/repo.
...
func runScan(cmd *cobra.Command, args []string) {
	...
	if strings.HasPrefix(path, "https://github.com/") || strings.HasPrefix(path, "git@github.com:") {
		// It's a GitHub URL
		if verbose {
